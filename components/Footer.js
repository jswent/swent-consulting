    ...
    <footer>
      <div className="footer__area fix p-relative pt-200 pb-60">
        <div className="footer__shape">
          <img className="footer-shape-1" alt="" />
          <img className="footer-shape-2" alt="" />
        </div>
        <Container>
            ...
            <Col xl={4} lg={4} md={10} sm={10}>
              <div className="footer__widget wow fadeIn" data-wow-delay=".5s">
                <div className="footer__widget-logo">
                  <img alt="logo" />
                  <p>Swent Consulting is a sole proprietorship managed and operated singularly by James W. Swent IV.</p>
                </div>
              ...
              <div className="footer__widget footer__widget-mt">
                ...
                <div className="footer__widget-info">
                  ...
                  <div className="footer__widget-email d-flex align-items-center">
                    ...
                    <p>
                      <Link href="mailto:business@swent-consulting.com">
                        <a>business@swent-consulting.com</a>
                      </Link>
                    </p>
                  </div>
                </div>
