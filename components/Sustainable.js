          ...
          <Row className="align-items-center">
            <Col xl={5} lg={6} md={9} sm={10}>
              <div className="experience__content">
                <SectionTitle subTitle="Sustainable development"
                  titleFirst="Actively involved in" titleSecond="sustainable growth" />
                <p>At Swent Consulting, we are aware of the current threats to our ecosystem, which is why we are committed to donating 10% of all our profits to the
                  <Link href="/">
                    <a>Climate Foundation</a>
                  </Link>
                  .
                </p>
              </div>
